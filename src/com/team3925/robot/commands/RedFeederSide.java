 ...
 *
 */
public class RedFeederSide extends CommandGroup {

    public RedFeederSide() {
        // Add Commands here:
        ...
        // arm.
    	addSequential(new SimpleGyroDrive(96 - 10, 3));
    	addSequential(new SimpleGyroTurn(59, 15), 3);
...
//    	addSequential(new SimpleGyroTurn(52, 15));
