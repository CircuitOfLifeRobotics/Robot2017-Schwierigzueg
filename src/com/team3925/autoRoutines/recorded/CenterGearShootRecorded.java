...
public class CenterGearShootRecorded extends CommandGroup {

	public CenterGearShootRecorded() {
		Recorder<RobotState> recorder = null;
		try {
			recorder = (Recorder<RobotState>) Recorder.recall(new FileInputStream(Robot.recordFilePath+"centerGear"+Robot.recordExtension));
