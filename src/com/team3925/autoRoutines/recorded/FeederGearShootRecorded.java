...
public class FeederGearShootRecorded extends CommandGroup {

	public FeederGearShootRecorded() {
		Recorder<RobotState> recorder = null;
		try {
			recorder = (Recorder<RobotState>) Recorder.recall(new FileInputStream(Robot.recordFilePath+"feederGear"+Robot.recordExtension));
